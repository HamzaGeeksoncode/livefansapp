...
class WalletController extends Controller
{
    public function addCoin(Request $request)
    {
        ...
        if ($rewarding_action_id == 3) {
            $insert_coin = User::where('user_id', $user_id)->increment('upload_video', $settings->reward_video_upload);
    ...
    public function getMyWalletCoin(Request $request)
    {
        ...
        $data['total_received'] = $data->total_received ? (int)$data->total_received : 0;
        $data['total_send'] = $data->total_send ? (int)$data->total_send : 0;
        $data['my_wallet'] = $data->my_wallet ? (int)$data->my_wallet : 0;
        $data['spen_in_app'] = $data->spen_in_app ? (int)$data->spen_in_app : 0;
        $data['check_in'] = $data->check_in ? (int)$data->check_in : 0;
        $data['upload_video'] = $data->upload_video ? (int)$data->upload_video : 0;
        $data['from_fans'] = $data->from_fans ? (int)$data->from_fans : 0;
        $data['purchased'] = $data->purchased ? (int)$data->purchased : 0;
